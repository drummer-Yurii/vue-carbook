...
import FooterLinks from '@/components/composables/FooterLinks.vue';
      ...
      <div class="flex flex-col md:flex-row gap-10 justify-between">
        <div class="md:w-1/5 space-y-6">
          ...
          <p class="text-gray-400 text-base">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur voluptatum labore
            enim ea tenetur, voluptate minus.
          </p>
        ...
        <div class="md:w-1/5">
          ...
          <div class="flex flex-col space-y-4 mt-6">
            ...
            >
              ...
              <p class="text-gray-400 text-md">{{ info.text }}</p>
            </div>
          </div>
        </div>
      </div>
      <div>
        <p class="text-gray-300 text-md text-center mt-16">
